...
/**
 * <p>Classe de <i>interações</i> genéricas para ser utilizada no padrão <strong>Page Object</strong>.
 * 
...
public class Interactions implements INavegador {
	...
	/**
	 * <p><strong>Função:</strong> acessar uma URL.
	 * 
	 ...
	 * <li>escrever()</li>
	 * </ul>
	 * <p><strong>Função:</strong> escreve uma {@link String string} no elemento especificado.
	 * 
	 ...
	 * <li>escreverSlow()</li>
	 * </ul>
	 * <p><strong>Função:</strong> escreve lentamente uma {@link String string} no elemento especificado.
	 * 
	 * @param by é o {@link By seletor} do elemento.
	 * @param text é a {@link String string} a ser escrita no elemento.
	 * @param description é o {@link String nome} do elemento.
	 ...
	 * <li>limpar()</li>
	 * </ul>
	 * <p><strong>Função:</strong> limpa o texto no elemento especificado.
	 * 
	 * @param by é o {@link By seletor} do elemento.
	 * @param description é o {@link String nome} do elemento.
	 * @return {@link Void void}
	 ...
	 * <li>clicar()</li>
	 * </ul>
	 * <p><strong>Função:</strong> clica no elemento especificado. 
	 * 
	 * @param by é o {@link By seletor} do elemento.
	 * @param description é o {@link String nome} do elemento.
	 * @return {@link Void void}
	 ...
	 * </ul>
	 * <p><strong>Função:</strong> verifica se o elemento especificado está selecionado/marcado. 
	 * 
	 * @param by é o {@link By seletor} do elemento.
	 * @param description é o {@link String nome} do elemento.
	 ...
	 * <li>obterTexto()</li>
	 * </ul>
	 * <p><strong>Função:</strong> obtém, loga e retorna o valor textual do elemento especificado ou {@link Null null} em caso de falha. 
	 * 
	 * @param by é o {@link By seletor} do elemento.
	 * @param description é o {@link String nome} do elemento.
	 ...
	 * <li>validaPagina()</li>
	 * </ul>
	 * <p><strong>Função:</strong> Valida se a página atual é a página desejada e verifica se a mesma está carregada.
	 * 
	 * @param by é o {@link By seletor} do elemento.
	 * @param text é a {@link String string} validadora à ser comparada com o texto obtido do elemento.
	 * @param description é o {@link String nome} do elemento.
	 * @return {@link Void void}
	 * @throws NoSuchElementException caso o elemento não existir.
	 * @throws TimeoutException caso exceder o tempo de carregamento do elemento.
	 ...
	 * </ul>
	 * 
	 * <p><strong>Função:</strong> esta interação tem a função de retornar um atributo específico de um elemento ou {@link Null null} caso o atributo não exista.
	 * @param by é o {@link By seletor} do elemento.
	...
	/**
	 * @deprecated 
	 * <p>Ao invés disso utilize o método {@link #awaitElement(By, String)}.
	 * <p><strong>Substitui:</strong>
	 * <ul>
	 * <li>aguarda()</li>
	 * </ul>
	 * <p><strong>Função:</strong> faz com que a thread entre no modo "sleep" por um determinado período de tempo.
	...
	/**
	 * <p><strong>Função:</strong> compara duas unidades de tempo em segundos e retorna uma
	 * {@link String mensagem} descrevendo o tempo decorrido.
	 ...
	 * </ul>
	 * <p><strong>Função:</strong> aguarda o tempo de carregamento informado de um elemento,
	 * lançando uma exceção caso esse tempo seja ultrapassado. Também informa quanto 
	 * tempo levou para que o elemento fosse carregado em caso de sucesso.
	 * @param by é o {@link By seletor} do elemento.
	 ...
	 * <li>esperarElemento()</li>
	 * </ul>
	 * <p><strong>Função:</strong> aguarda o tempo de carregamento de um elemento por 15 segundos,
	 * lançando uma exceção caso esse tempo seja ultrapassado. Também informa quanto 
	 * tempo levou para que o elemento fosse carregado em caso de sucesso.
	 * @param by é o {@link By seletor} do elemento.
	 * @param description é o {@link String nome} do elemento.
	 ...
	 * <li>elementExists()</li>
	 * </ul>
	 * <p><strong>Função:</strong> verifica se o elemento especificado está visível na tela.
	 * @param by é o {@link By seletor} do elemento.
	 * @param description é o {@link String nome} do elemento.
	 * @return {@link Boolean boolean}
	 * @throws NoSuchElementException caso o elemento não existir.
	 ...
	 * </ul>
	 * <p><strong>Função:</strong> cria uma lista de elementos e clica em um deles aleatoriamente.
	 * @param by é o {@link By seletor} do elemento.
	 ...
	 * <li>combo()</li>
	 * </ul>
	 * <p><strong>Função:</strong> seleciona um elemento de uma lista dropdown (combo) através do atributo "value" (e não do texto aparente).
	 * @param by é o {@link By seletor} do elemento.
	 * @param value é o {@link String valor} da opção do combo (e não o seu texto).
	 * @param description é o {@link String nome} do elemento.
	 * @return {@link Void void}
	 * @throws NoSuchElementException caso o elemento não existir.
	 * @throws TimeoutException caso exceder o tempo de carregamento do elemento.
	...
	/**
	 * <p><strong>Função:</strong> manipula um elemento do tipo slider apenas em seu eixo horizontal.
	 * Caso esse método não funcione, experimente o {@link #sliderSendKeys(By, Integer, String)}
	 * @param by é o {@link By seletor} do elemento.
	 * @param number é o {@link Integer número} utilizado para quantificar o movimento do elemento.
	 * @param description é o {@link String nome} do elemento.
	 * @return {@link Void void}
	 * @throws NoSuchElementException caso o elemento não existir.
	 * @throws TimeoutException caso exceder o tempo de carregamento do elemento.
	 ...
	 * <li>sliderComSeta()</li>
	 * </ul>
	 * <p><strong>Função:</strong> manipula um elemento do tipo slider apenas em seu eixo horizontal utilizando o método sendKeys para a direita.
	 * Caso esse método não funcione, experimente o {@link #slider(By, Integer, String)}
	 * @param by é o {@link By seletor} do elemento.
	 * @param repetitions é a {@link Integer quantidade} de vezes que o comando de seta será enviada.
	 * @param description é o {@link String nome} do elemento.
	 * @return {@link Void void}
	 * @throws NoSuchElementException caso o elemento não existir.
	 * @throws TimeoutException caso exceder o tempo de carregamento do elemento.
	 ...
	 * <li>entrarFrame()</li>
	 * </ul>
	 * <p><strong>Função:</strong> troca o frame atual pelo index especificado no parâmetro.
	 ...
	 * <li>entrarFrame()</li>
	 * </ul>
	 * <p><strong>Função:</strong> troca o frame atual pelo nome especificado no parâmetro.
	...
	/**
	 * <p><strong>Função:</strong> retorna para o frame do conteúdo principal.
	 * @return {@link Void void}
	 * @throws NoSuchElementException caso o elemento não existir.
	 * @throws TimeoutException caso exceder o tempo de carregamento do elemento.
	 * @throws ElementNotVisibleException caso a visão do elemento estiver obstruída ou ele estiver oculto.
